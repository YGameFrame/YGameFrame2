 ...
 * 
 * <p>
 * <b>概述</b>：组成<b><i>游戏实体</i></b>的三个部件之一，具体的<b>逻辑</b>
 * 需要继承该类得以实现。 被<b>游戏逻辑</b>{@link YAGameLogic}
 * 管理，为了能被纳入管理，需要通过
 ...
 * {@link #onSubmitCurrentTasks()}、
 * {@link #onSendRequests(Map)} 是被框架异步调用的。
 * <li>
...
public abstract class YABaseDomainLogic<D extends YABaseDomainData> implements YIReceiver
{
	...
	/**
	 * <b>逻辑广播</b>：本对象收听的<b><i>逻辑</i></b><b>广播</b>
	 * {@link YIBroadcast} ，用于向其他<b>领域逻辑</b>
	 * {@link YABaseDomainLogic}发送自己的状态变化
	 */
	protected YIBroadcast broadcastLogic;

	/**
	 * <b>消息句柄</b>：向<b>游戏逻辑</b>{@link YAGameLogic}
	 * 发送消息的句柄
	 */
	...
	/**
	 * 向框架或其它<b>领域逻辑</b>{@link YABaseDomainLogic}
	 * 发送<b>请求</b>{@link YRequest} ，
	 * <b>请求</b>应封装在msg.what中，以消息的方式通过
	 * {@link #handlerGameLogic}发送出去
	 * 
	 * @param domainLogics
	 *                逻辑列表
	 */
	protected abstract void onSendRequests(
	...
	/**
	 * 处理其他<b>领域逻辑</b>{@link YABaseDomainLogic}
	 * 发来的<b>请求</b> {@link YRequest}
	 * 和玩家发来的<b>请求</b>，处理完成后建议做相应的记录， 以备向框架交付<b>任务</b>
	 * {@link YITask}的时候作为依据
	 * 
	 * @param request
	 *                收到的<b>请求</b>
