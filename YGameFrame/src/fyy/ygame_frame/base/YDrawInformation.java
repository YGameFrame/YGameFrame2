 ...
 * 
 * <p>
 * <b>概述</b>： 由于<b>领域逻辑</b>计算产生，包含了<b>领域视图</b>
 * {@link YABaseDomainView}必要的绘图信息。
 * 
 * @author FeiYiyun
 * 
 */
public final class YDrawInformation
{
	 ...
	 * 
	 * <p>
	 * <b>概述</b>： <b>领域逻辑</b>{@link YABaseDomainLogic}
	 * 计算完绘图需要的信息后，在此表单中填写这些信息， 这些信息将会被路由到<b>领域视图</b>
	 * {@link YABaseDomainView}去绘制。
	 * 
	 * <p>
	 * <b>注</b>： 表单中的绘图信息<b>不会</b>被自动清除。
	 * 
	 * @author FeiYiyun
	 * 
	 */
