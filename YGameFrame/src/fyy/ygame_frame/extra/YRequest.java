 ...
 * 
 * <p>
 * <b>概述</b>： 来自于<b>玩家操作</b>和<b>游戏内部计算</b>，通过<b>游戏逻辑</b>
 * {@link YAGameLogic}的消息句柄发往<b>游戏逻辑</b>，最后被相应的 <b>领域逻辑</b>
 * {@link YABaseDomainLogic}收到。
 * 
 * <p>
 * <b>注</b>：
 * <li>
 * 一个<b>请求</b>针对于<b>开始</b>或<b>结束</b>某个操作，发送<b>请求</b>时应该注意这点。
...
public final class YRequest
{
	...
	/**
	 * @param iPriority
	 *                <b>请求</b>{@link YRequest}的优先级
	 * @param iKey
	 *                <b>请求</b>的键值
	 * @param domainLogicReceivers
	 *                <b>请求</b>接收者，可多个
	 */
